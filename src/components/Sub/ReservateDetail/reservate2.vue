    ...
    <div class="container">
      <div class="img-con">
        ...
        <div class="descript">
          ...
          <p>- 2인의 크리에이터가 콘텐츠를 촬영할 수 있는 공간입니다.</p>
          <p>
          ...
          <div class="schedule-con">
            ...
            <div class="price-con" v-if="timeHour != 0">
              ...
              <div class="price-box">
                <span class="price-text">
                  인원수
                  {{ this.num }}명 x {{ rooms[1].numPrice.toLocaleString() }}원
                  ( 최소 {{ rooms[1].numMin }}명 ~ 최대 {{ rooms[1].numMax }}명)
                </span>
                <span class="price-value">
...
export default {
  ...
  methods: {
    ...
    PriceCalc() {
      ...
      this.totalPrice =
        this.rooms[1].price * this.timeHour +
        this.equipmentPrice +
        this.numPrice;
    },
