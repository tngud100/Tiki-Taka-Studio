<template>
  <section class="news_section">
    ...
    <div class="title-con">
      <span class="title">티앤티 스튜디오 {{ rooms[5].title }}</span>
    </div>
    <div class="container">
      <div class="img-con">
      ...
      <div class="info-con">
        <div class="info">
          <div class="title-info">
            ...
            <p class="price">{{ rooms[5].price }}원</p>
          </div>
          <hr />
          <div class="schedule-con">
            ...
            <div class="price-con" v-if="timeHour != 0">
              ...
              <div style="display: flex; justify-content: space-between">
                <span
                  >{{ rooms[5].price.toLocaleString() }}원 x
              ...
              <div style="display: flex; justify-content: space-between">
                <span>
                  {{ rooms[5].numPrice.toLocaleString() }}원 x
                  {{ this.num }}명</span
                >
                <span>
                  {{ (rooms[5].numPrice * this.num).toLocaleString() }}원
                </span>
              </div>
...
export default {
  ...
  methods: {
    ...
    PriceCalc() {
      this.totalPrice =
        this.rooms[5].price * this.timeHour + this.rooms[5].numPrice * this.num;
    },
    getDisabledate() {
      $.ajax({
        /* 요청 시작 부분 */
