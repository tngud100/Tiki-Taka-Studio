<template>
  <section class="news_section">
    ...
    <div class="title-con">
      <span class="title">{{ rooms[3].title }}</span>
    </div>
    <div class="container">
      <div class="img-con">
        <img :src="rooms[3].imageSrc" class="img" alt="studio" />
        <div class="img-info">
      ...
      <div class="info-con">
        <div class="info">
          <div class="title-info">
            <div>
              <p class="title">{{ rooms[3].title }}</p>
              <p class="price">
                {{ rooms[3].price.toLocaleString() }}원
          ...
          <div class="schedule-con">
            ...
            <p class="sub-title">
              인원 초과시 인당
              {{ this.rooms[3].numPrice.toLocaleString() }}원 추가 비용 발생
            </p>
            <v-text-field
              label="인원수를 입력해 주세요."
              persistent-hint
...
export default {
  ...
  methods: {
    ...
    plusBtn() {
      this.num++;
      if (this.num >= this.rooms[3].numMax) {
        this.num = this.rooms[3].numMax;
      }
    ...
    PriceCalc() {
      this.numPrice =
        this.rooms[3].numPrice * (this.num - this.rooms[3].numMin);
      if (this.num <= this.rooms[3].numMin) {
        this.numPrice = 0;
      }
    ...
    rooomCalc() {
      const priceHour3 = this.rooms[3].PriceToHour3;
      const priceHour6 = this.rooms[3].PriceToHour6;
      const priceHour12 = this.rooms[3].PriceToHour12;
      var price = this.rooms[3].price;
      if (this.timeHour >= 3 && this.timeHour < 6) {
