  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-05-30
          </p>
          <span class="title_text">한국건강가정진흥원 교육 이수</span>
        </div>
        <div class="content_con">
          <div class="text"></div>
          <div class="img_con">
            <div class="upper_box">
              <!-- <img class="news_img" :src="require('@/assets/news/news25.svg')" /> -->
              <p class="sub_imgtext">한국건강진흥원 교육 이수증</p>
            </div>
          </div>
        </div>
