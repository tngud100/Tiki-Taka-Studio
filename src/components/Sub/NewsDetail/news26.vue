  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-06-22
          </p>
          <span class="title_text">일 생활균형 일촌기업 사업 참여 </span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news26.svg')"
              />
              <p class="sub_imgtext">캠페인 참여확인서</p>
            </div>
          </div>
        </div>
