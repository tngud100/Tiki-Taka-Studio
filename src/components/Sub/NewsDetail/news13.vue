  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-11-24
          </p>
          <span class="title_text"> 소상공인IP역량 강화 교육 수료 </span>
        </div>
        <div class="content_con">
          <div class="text">
            (주)게임인스는 2022년 11월 24일, 부산지식재산센터에서 운영한
            소상공인IP역략강화 교육을 수료하였습니다.
          </div>
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news13.svg')"
              />
              <p class="sub_imgtext">소상공인IP역략강화 교육</p>
            </div>
          </div>
        </div>
