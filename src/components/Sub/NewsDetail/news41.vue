  ...
  <section class="news9_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2024-03-05
          </p>
          <span class="title_text">대한적십자 헌혈유공자 포장증</span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news42.svg')"
              />
              <p class="sub_imgtext">포장증</p>
            </div>
          </div>
        </div>
