  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2022-02-14
          </p>
          <span class="title_text">중소기업 인증 </span>
        </div>
        <div class="content_con">
          <div class="text"></div>
          <div class="img_con">
            <div class="upper_box">
              <img class="news_img" :src="require('@/assets/news/news1.svg')" />
              <p class="sub_imgtext">중소기업 확인서</p>
            </div>
          </div>
        </div>
