  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-03-01
          </p>
          <span class="title_text">
            2023년 부산청년 파란일자리 지원사업 참여
          </span>
        </div>
        <div class="content_con">
          <div class="text">
            (주)게임인스는 2023년 3월 1일을 기점으로 부산경영자총협회가 운영하는
            부산청년 파란일자리 지원사업에 참여할 것은 협약하였습니다.
          </div>
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news18.svg')"
              />
              <p class="sub_imgtext">파란일자리 지원사업 참여</p>
            </div>
          </div>
        </div>
