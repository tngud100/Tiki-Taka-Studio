  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2022-04-07
          </p>
          <span class="title_text">통신판매업 신고 </span>
        </div>
        <div class="content_con">
          <div class="text"></div>
          <div class="img_con">
            <div class="upper_box">
              <img class="news_img" :src="require('@/assets/news/news3.svg')" />
              <p class="sub_imgtext">통신판매업 신고증</p>
            </div>
          </div>
        </div>
