  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2022-11-11
          </p>
          <span class="title_text"> 사회적경제 창업 아카데미 교육 이수 </span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news11.svg')"
              />
              <p class="sub_imgtext">창업 아카데미 교육 이수</p>
            </div>
          </div>
        </div>
