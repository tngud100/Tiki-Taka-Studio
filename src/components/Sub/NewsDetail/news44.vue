  ...
  <section class="news9_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2024-05-29
          </p>
          <span class="title_text">부산북부고용센터 구인, 구직 만남의 날</span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news45-1.svg')"
              />
            </div>
          </div>
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news45-2.svg')"
              />
              <p class="sub_imgtext">부산북부고용센터</p>
            </div>
          </div>
        </div>
