  ...
  <section class="news9_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-10-23
          </p>
          <span class="title_text">2023년 연제구 일자리박람회</span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news33.png')"
              />
              <p class="sub_imgtext">연제구 일자리박람회</p>
            </div>
          </div>
        </div>
