  ...
  <section class="news9_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2024-06-04
          </p>
          <span class="title_text">2024 서부산권일자리박람회</span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news46-1.svg')"
              />
            </div>
          </div>
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news46-2.svg')"
              />
            </div>
          </div>
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news46-3.svg')"
              />
              <p class="sub_imgtext">강서구청역 2층 로비</p>
            </div>
          </div>
        </div>
