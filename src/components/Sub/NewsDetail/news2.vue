  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2022-03-15
          </p>
          <span class="title_text">기업부설연구소 인정서 </span>
        </div>
        <div class="content_con">
          <div class="text"></div>
          <div class="img_con">
            <div class="upper_box">
              <img class="news_img" :src="require('@/assets/news/news2.svg')" />
              <p class="sub_imgtext">기업부설연구소 인정서</p>
            </div>
          </div>
        </div>
