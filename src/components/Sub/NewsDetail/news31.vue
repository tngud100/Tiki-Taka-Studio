  ...
  <section class="news9_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-10-20
          </p>
          <span class="title_text">사상여성인력개발센터 업무 협약</span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news32.svg')"
              />
              <p class="sub_imgtext">사상여성인력개발센터 업무 협약서</p>
            </div>
          </div>
        </div>
