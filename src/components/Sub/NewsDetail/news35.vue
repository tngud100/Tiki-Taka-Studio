  ...
  <section class="news9_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-11-08
          </p>
          <span class="title_text">2023년 동서대학교 취업박람회</span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news36.jpg')"
              />
              <p class="sub_imgtext">동서대학교 취업박람회</p>
            </div>
          </div>
        </div>
