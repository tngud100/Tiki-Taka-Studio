  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-02-17
          </p>
          <span class="title_text"> 1차 법정의무교육 진행 </span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news16.svg')"
              />
              <p class="sub_imgtext">1차 법정의무교육</p>
            </div>
          </div>
        </div>
