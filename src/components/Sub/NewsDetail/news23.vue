  ...
  <section class="news_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-04-26
          </p>
          <span class="title_text">센텀직업전문학교_업무 협약 </span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news23.svg')"
              />
              <p class="sub_imgtext">업무협약서</p>
            </div>
          </div>
        </div>
