  ...
  <section class="news9_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-11-01
          </p>
          <span class="title_text">산학협력 체결서_정보영스피치</span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news35.svg')"
              />
              <p class="sub_imgtext">산업협력 체결서_정보영스피치</p>
            </div>
          </div>
        </div>
