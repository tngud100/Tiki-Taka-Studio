  ...
  <section class="news9_section">
    ...
    <div class="container">
      <div class="box">
        <div class="title_con">
          <p class="date_text">
            <span style="color: black">회사 소식 |</span> 작성 일자 : 2023-12-01
          </p>
          <span class="title_text">가족친화인증서 취득</span>
        </div>
        <div class="content_con">
          ...
          <div class="img_con">
            <div class="upper_box">
              <img
                class="news_img"
                :src="require('@/assets/news/news38.png')"
              />
              <p class="sub_imgtext">가족친화인증서</p>
            </div>
          </div>
        </div>
